...
dsp_create_modules_envelope_segment(struct dsp_bus *target_bus,
  ...
  math_modules_envelope_segment_init(params.parameters);
  ...
  printf("dsp_create_modules_envelope_segment::dsp_add_module()\n");
  return 0;
} /* dsp_create_modules_envelope_segment */

void
dsp_modules_envelope_segment(struct dsp_operation *envelope_segment, int jack_samplerate, int pos) {
  float insample = 0.0f;
  float outsample = 0.0f;

  outsample = math_modules_envelope_segment(envelope_segment->module->dsp_param.parameters,
                                                  jack_samplerate,
                                                  pos);
  /* printf("outsample: %f\n", outsample); */
  /* drive audio outputs */
...
dsp_edit_modules_envelope_segment(struct dsp_module *envelope_segment,
  ...
  /* printf("ops_modules_envelope_segment.c::dsp_edit_modules_envelope_segment()\n"); */
  ...
  /* printf("time_scale: %f\n", time_scale); */
  /* printf("\n\n"); */
  math_modules_envelope_segment_edit(envelope_segment->dsp_param.parameters,
                                              release_node,
                                              loop_node,
                                              offset,
                                              gate,
  ...
  printf("dsp_edit_modules_envelope_segment::returning\n");
} /* dsp_edit_modules_envelope_segment */
