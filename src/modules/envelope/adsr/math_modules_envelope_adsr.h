...
extern void
math_modules_envelope_adsr_init(dsp_module_parameters_t *parameters,
                                         float attack_rate,
                                         float decay_rate,
                                         float release_rate,
                                         float sustain_level,
...
extern void
math_modules_envelope_adsr_edit(dsp_module_parameters_t *parameters,
                                         int gate,
                                         float attack_rate,
                                         float decay_rate,
                                         float release_rate,
...
extern float
math_modules_envelope_adsr(dsp_module_parameters_t *parameters, int samplerate, int pos);
