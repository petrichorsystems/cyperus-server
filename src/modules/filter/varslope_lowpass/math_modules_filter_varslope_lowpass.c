...
void math_modules_filter_varslope_lowpass_init(dsp_module_parameters_t *parameters, int jack_sr) {
...
void math_modules_filter_varslope_lowpass_edit(dsp_module_parameters_t *parameters) {
  cyperus_lo_designVarSlopeFilter(parameters);
}

float math_modules_filter_varslope_lowpass(dsp_parameter *filter, int samplerate, int pos) {
