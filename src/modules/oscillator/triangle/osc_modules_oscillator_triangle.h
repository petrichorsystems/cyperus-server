...
#ifndef OSC_MODULES_OSCILLATOR_TRIANGLE_H
#define OSC_MODULES_OSCILLATOR_TRIANGLE_H
...
int osc_edit_modules_oscillator_triangle_handler(const char *path, const char *types, lo_arg ** argv,
                                                int argc, void *data, void *user_data);
