/* math_modules_audio_filter_bandpass.c
...
extern
float math_modules_audio_filter_bandpass_init(dsp_parameter *filter) {
...
extern
float math_modules_audio_filter_bandpass(dsp_parameter *filter, int samplerate, int pos) {
