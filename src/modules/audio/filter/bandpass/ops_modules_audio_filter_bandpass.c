/* ops_modules_audio_filter_bandpass.c
...
#include "math_modules_audio_filter_bandpass.h"
...
dsp_create_filter_bandpass(struct dsp_bus *target_bus,
  ...
  math_modules_audio_filter_bandpass_init(&params);
...
dsp_filter_bandpass(struct dsp_operation *filter_bandpass, int jack_samplerate, int pos) {
  ...
  */
  ...
  outsample = math_modules_audio_filter_bandpass(&filter_bandpass->module->dsp_param,
                                               jack_samplerate,
                                               pos);
