/* ops_modules_audio_oscillator_triangle.c
...
#include "math_modules_audio_oscillator_triangle.h"
...
dsp_oscillator_triangle(struct dsp_operation *oscillator_triangle, int jack_samplerate, int pos) {
  ...
  outsample = math_modules_audio_oscillator_triangle(oscillator_triangle->module->dsp_param.parameters,
                                                  jack_samplerate,
                                                  pos);  
  /* drive audio outputs */
