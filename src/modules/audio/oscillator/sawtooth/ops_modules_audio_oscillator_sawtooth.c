/* ops_modules_audio_oscillator_sawtooth.c
...
#include "math_modules_audio_oscillator_sawtooth.h"
...
dsp_oscillator_sawtooth(struct dsp_operation *oscillator_sawtooth, int jack_samplerate, int pos) {
  ...
  outsample = math_modules_audio_oscillator_sawtooth(oscillator_sawtooth->module->dsp_param.parameters,
                                                  jack_samplerate,
                                                  pos);  
  /* drive audio outputs */
