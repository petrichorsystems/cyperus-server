...
#ifndef OSC_MODULES_OSC_OSC_METRONOME_H
#define OSC_MODULES_OSC_OSC_METRONOME_H
...
int osc_edit_modules_osc_osc_metronome_handler(const char *path, const char *types, lo_arg ** argv,
                                              int argc, void *data, void *user_data);
