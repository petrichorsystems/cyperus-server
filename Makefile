...
core = src/main.c src/dsp.c src/dsp_types.c src/dsp_ops.c src/dsp_math.c src/jackcli.c src/osc.c src/osc_handlers.c src/osc_string.c src/dsp_graph_id.c src/threadsync.c
